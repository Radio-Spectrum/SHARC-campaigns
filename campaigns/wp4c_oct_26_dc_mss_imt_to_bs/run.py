...
import sys
import sharc
from campaigns.wp4c_oct_26_dc_mss_imt_to_bs.constants import CAMPAIGN_NAME, INPUTS_DIR
from campaigns.wp4c_oct_26_dc_mss_imt_to_bs.generate_inputs import (
    clear_inputs,
    generate_inputs,
)
...
def main():
    parser = argparse.ArgumentParser(
        description="MSS D2D to BS campaign runner"
    )
    parser.add_argument(
        "-dg", "--dont-generate",
        action="store_true",
