...
from campaigns.mss_d2d_to_mss_adj_study_system_2.constants import CAMPAIGN_DIR, INPUTS_DIR, OUTPUT_DIR
...
- **Campaign**: mss_d2d_to_mss_adj_study (Adjacent Channel Scenario)
