...
from campaigns.multiple_mss_dc_to_imt.generate_inputs import clear_inputs, generate_inputs
from campaigns.multiple_mss_dc_to_imt.constants import CAMPAIGN_NAME, INPUTS_DIR
    ...
    if not args.dont_generate:
        ...
        if not INPUTS_DIR.exists() or not any(INPUTS_DIR.glob("*.yaml")):
            print(
                ...
                "Remove --dont-generate or r un the generator first."
            )
            return 2
