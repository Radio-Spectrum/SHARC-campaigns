...
# Import functions from plot_ccdf_inr.py
from campaigns.imt_to_mss_18.plot_ccdf_inr import (
    OUTPUT_DIR,
    INR_FILE,
    PROTECTION_CRITERIA,
...
CLUTTER_TYPE = "both_ends"  # Options: "one_end", "both_ends", or None
...
HEIGHT = 1 # Options: 5, 40, or None for all
