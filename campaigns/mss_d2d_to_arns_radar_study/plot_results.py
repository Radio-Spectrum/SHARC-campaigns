...
from campaigns.mss_d2d_to_arns_radar_study.constants import (
...
for mss_dc_id, mss_es_id, load_factor, offset_label, antenna_model in product(
    ...
    post_processor.add_plot_legend_pattern(
        ...
        legend=f"{readable_load}; {readable_sys}; {readable_mss}, {OFFSET_LABELS_READABLE[offset_label]}, {antenna_model}"
    )
...
for attr, plot_type in attributes_to_plot:
    ...
    if attr == "system_inr":
        ...
        plot.add_vline(x=-10.0, line_dash="dot", line_color="gray", annotation_text="-10dB", annotation_position="top left")
