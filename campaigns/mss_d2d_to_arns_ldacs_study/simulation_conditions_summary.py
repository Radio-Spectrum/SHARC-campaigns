...
from campaigns.mss_d2d_to_arns_ldacs_study.constants import CAMPAIGN_DIR, INPUTS_DIR, OUTPUT_DIR
...
### Campaign Overview
- **Name**: mss_d2d_to_arns_ldacs_study
...
- **Campaign**: mss_d2d_to_arns_ldacs_study (Adjacent Channel Scenario)
