...
if __name__ == "__main__":
    ...
    #           radius_km: 2700.0
    params.beam_positioning.type = "SERVICE_GRID"
    params.beam_positioning.service_grid.transform_grid_randomly = True
    params.beam_positioning.service_grid.grid_in_zone.type = "CIRCLE"
    params.beam_positioning.service_grid.grid_in_zone.circle.center_lat = -25.2637
    params.beam_positioning.service_grid.grid_in_zone.circle.center_lon = -57.5759
    params.beam_positioning.service_grid.grid_in_zone.circle.radius_km = 1000.0
