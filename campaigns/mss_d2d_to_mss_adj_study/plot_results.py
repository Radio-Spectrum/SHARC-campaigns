...
def plot_ccdf_inr(
    ...
    for csv_path in inr_files:
        ...
        # Determine label
        if matched_filter and len(matched_filter) >= 4 and matched_filter[3]:
            # Use custom label from filter tuple
            label = matched_filter[3]
        else:
...
if __name__ == "__main__":
    ...
    curves_to_plot = [
        ...
        (0.1, "offset_minus5MHz", "7.1.4-forward-R", "525km", "System R @ 525km - (-5 MHz, 2157.5 MHz)"),
        (0.1, "offset_minus10MHz", "7.1.4-forward-R", "525km", "System R @ 525km - (-10 MHz, 2152.5 MHz)"),
        (0.1, "offset_minus15MHz", "7.1.4-forward-R", "525km", "System R @ 525km - (-15 MHz, 2142.5 MHz)"),
        
        # @ 340 km
        #(0.1, "offset_0MHz", "7.1.4-forward-R", "340km", "System R @ 340km - Nominal (2162.5 MHz)"),
        (0.1, "offset_minus5MHz", "7.1.4-forward-R", "340km", "System R @ 340km - (-5 MHz, 2157.5 MHz)"),
        (0.1, "offset_minus10MHz", "7.1.4-forward-R", "340km", "System R @ 340km - (-10 MHz, 2152.5 MHz)"),
        (0.1, "offset_minus15MHz", "7.1.4-forward-R", "340km", "System R @ 340km - (-15 MHz, 2142.5 MHz)"),
        
        # ========== ES Type-1 (7.1.5-ES-type-1) ==========
        # @ 525 km
        #(0.1, "offset_0MHz", "7.1.5-ES-type-1", "525km", "ES Type-1 @ 525km - Nominal (2162.5 MHz)"),
        #(0.1, "offset_minus5MHz", "7.1.5-ES-type-1", "525km", "ES Type-1 @ 525km - (-5 MHz, 2157.5 MHz)"),
        #(0.1, "offset_minus10MHz", "7.1.5-ES-type-1", "525km", "ES Type-1 @ 525km - (-10 MHz, 2152.5 MHz)"),
        #(0.1, "offset_minus15MHz", "7.1.5-ES-type-1", "525km", "ES Type-1 @ 525km - (-15 MHz, 2142.5 MHz)"),
        
        # @ 340 km
        #(0.1, "offset_0MHz", "7.1.5-ES-type-1", "340km", "ES Type-1 @ 340km - Nominal (2162.5 MHz)"),
        #(0.1, "offset_minus5MHz", "7.1.5-ES-type-1", "340km", "ES Type-1 @ 340km - (-5 MHz, 2157.5 MHz)"),
        #(0.1, "offset_minus10MHz", "7.1.5-ES-type-1", "340km", "ES Type-1 @ 340km - (-10 MHz, 2152.5 MHz)"),
        #(0.1, "offset_minus15MHz", "7.1.5-ES-type-1", "340km", "ES Type-1 @ 340km - (-15 MHz, 2142.5 MHz)"),
